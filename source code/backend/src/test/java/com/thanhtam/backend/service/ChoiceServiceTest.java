...
public class ChoiceServiceTest {
    ...
    /**
     * Test case TC009: Tìm isCorrected theo ID âm
     * Mục đích: Kiểm tra service trả về null khi tìm kiếm
     *          giá trị isCorrected với ID âm
     */
    @Test
    public void testFindIsCorrectedById_WithNegativeId() {
        // Khi
        Integer isCorrected = choiceService.findIsCorrectedById(-1L);
    ...
    /**
     * Test case TC010: Tìm nội dung lựa chọn theo ID âm
     * Mục đích: Kiểm tra service trả về null khi tìm kiếm
     *          nội dung lựa chọn với ID âm
     */
    @Test
    public void testFindChoiceTextById_WithNegativeId() {
        // Khi
        String choiceText = choiceService.findChoiceTextById(-1L);
